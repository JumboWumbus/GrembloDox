...
void render_layer(uint8_t layer) {
    ...
    switch (layer) {
    case 0:
        render_layer_helper_fun(1, PSTR("HOME"), 24, 4);
        break;
    case 1:
        render_layer_helper_fun(1, PSTR("NUMBER"), 12, 6);
        break;
    case 2:
        render_layer_helper_fun(1, PSTR("SYMBOL"), 12, 6);
        break;
    case 3:
        render_layer_helper_fun(1, PSTR("MOUSE"), 18, 5);
        break;
    case 4:
        render_layer_helper_fun(1, PSTR("TXTEDI"), 12, 6);
        break;
    case 5:
    default:
        render_layer_helper_fun(1, PSTR("RGBee"), 18, 5);
        break;
    }
}
